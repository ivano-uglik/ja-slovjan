        ...
        steps: [
          {
            ...
            component: "TextCompletion",
            params: {
              title: "Otče naš, _ktory_ jesi v nebesah,",
              titleTranslated: "Oče naš, koji jesi na nebesima,",
            },
          },
          {
            step: 1,
            component: "TextCompletion",
            params: {
              title: "_nehaj_ sveti se ime Tvoje.",
              titleTranslated: "sveti se ime Tvoje.",
            },
          },
          {
            step: 2,
            component: "TextCompletion",
            params: {
              title: "Nehaj _prijde_ kraljevstvo Tvoje,",
              titleTranslated: "Dođi kraljevstvo Tvoje,",
            },
          },
          {
            step: 3,
            component: "TextCompletion",
            params: {
              title: "nehaj bude volja Tvoja,",
              titleTranslated: "budi volja Tvoja,",
            },
          },
          {
            step: 4,
            component: "TextCompletion",
            params: {
              title: "kako _v_ nebu tako i na zemji.",
              titleTranslated: "kako na nebu, tako i na zemlji.",
            },
          },
        ],
      },
        ...
        steps: [
          {
            ...
            component: "TextCompletion",
            params: {
              title: "Hlěb naš _vsakodenny_ daj nam dnes,",
              titleTranslated: "Kruh naš svagdanji _daj_ nam danas,",
            },
          },
          {
            step: 1,
            component: "TextCompletion",
            params: {
              title: "i odpusti nam naše _grěhy_ ,",
              titleTranslated: "i otpusti nam dugove naše,",
            },
          },
          {
            step: 2,
            component: "TextCompletion",
            params: {
              title: "tako kako my _odpuščajemo_ našim _grěšnikam_ .",
              titleTranslated: "kako i mi otpuštamo dužnicima našim,",
            },
          },
          {
            step: 3,
            component: "TextCompletion",
            params: {
              title: "I ne _vvedi_ nas v _pokušenje_,",
              titleTranslated: "I ne uvedi nas u napast,",
            },
          },
          {
            step: 4,
            component: "TextCompletion",
            params: {
              title: "ale izbavi nas od _zlogo_.",
              titleTranslated: "nego izbavi nas od Zla!.",
            },
          },
          {
            step: 6,
